...
namespace LinqExercise
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("-------------");
            Console.WriteLine("First 4 acending");
            ...
            Console.WriteLine("-------------");
            Console.WriteLine("With age, descending");
            numbers[4] = 28;
            ...
            var yoeEmployee = employees.Where(x => x.YearsOfExperience <= 10 && x.Age > 35);

            var sumOfYOE = yoeEmployee.Sum(emp => emp.YearsOfExperience);
            var avgOfYOE = yoeEmployee.Average(emp => emp.YearsOfExperience);
            Console.WriteLine("-------------");
